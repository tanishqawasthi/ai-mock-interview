    ...
    <div>
      ...
      <Dialog open={openDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              <h2 className="font-bold text-2xl">Tell us more about the job you are interviewing</h2>
            </DialogTitle>
            <DialogDescription>
              ...
              <div>
                ...
                <div className="my-3">
                  ...
                  <Textarea placeholder="Eg. Node.js, Express.js, MongoDB, React.js" required onChange={(e)=> setJobDesc(e.target.value)} />
                </div>
              <div className="my-3">
                  <label htmlFor="">Years of Experience</label>
                  <Input placeholder="Eg. 2" type="number" max="50" required onChange={(e)=> setJobExperience(e.target.value)} />
                </div>
              </div>
